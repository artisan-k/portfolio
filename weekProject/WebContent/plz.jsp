								...
								success : function(data){
									...
									$(data).find('response').find('body').find('items').find('item').each(function(){
										...
										if(markerCnt<5){
											...
											// 마커 이미지의 이미지 주소입니다
											var imageSrc = "/weekProject/image/pickIcon-01.png";
...
<div id=mainBan>
	<div id="mainSub">
		...
		<div id="m_headline">
			...
			<h4>까지</h4><br>
			<h1>역이어때.</h1>
			<img id="logo" src="/weekProject/image/pickicon3.png">
		</div>
	</div>
</div>
...
<!-- 맛집 컨텐츠 -->
	<div id=contentBox>
		...
		<div id="map"></div>
		<div id="viewRes">
			<img src="../weekProject/image/before.png" class="PageMPoint btn_before" >
			<div id="viewList"></div>
			<img src="../weekProject/image/after.png" class="PageMPoint btn_after" >
		</div>
